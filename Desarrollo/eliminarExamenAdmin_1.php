    ...
    <div id="contentPagPpal">
      <div id="content_top">
        <div class="post">
		 ...
		 <p>&nbsp;</p>
		 <td align="left"><div align="center">Elija los exámenes que desea eliminar</div></td>
		  <p>&nbsp;</p>
          ...
          <table width="559" height="66" border="0" align="center">
		   <tr>
           	  <td width="27" height="30">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
           	    <input type="checkbox" name="ev1" id="ev1" /></td>
              <td width="522" height="30">&nbsp;&nbsp;&nbsp;Exámen Virtual 1</td>
            </tr><tr>
              <td width="27" height="30">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <input type="checkbox" name="ev2" id="ev1" /></td>
              <td width="522" height="30">&nbsp;&nbsp;&nbsp;Exámen Virtual 2</td>
            </tr><tr>
              <td width="27" height="30">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <input type="checkbox" name="ev3" id="ev1" /></td>
              <td width="522" height="30">&nbsp;&nbsp;&nbsp;Exámen Virtual 3</td>
            </tr><tr>
              <td width="27" height="30">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <input type="checkbox" name="ev4" id="ev1" /></td>
              <td width="522" height="30">&nbsp;&nbsp;&nbsp;Exámen Virtual 4</td>
            </tr>
          </table>
          <div align="center"><br />  
...
?>
	<script language="javascript">
		window.alert ("Se ha aleminado con éxito");
		window.location = "eliminarExamenAdmin_2";
	</script>          
<?
}
?>
