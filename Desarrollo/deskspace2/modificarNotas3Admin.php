      ...
      <div id="content_top">
        ...
        <form id="form1" name="form1" method="post" action="">
           <div align="center">
			...
			$queEmp = "SELECT p.`idPERSONA` as ident ,p.`nombre` as nombre, p.`apellido` as apellido, p.`segundoNombre` as nombre2, p.`segundoApellido` as apellido2, t.`nota` as nota, t.`idEvaluacion` as idEvaluacion  FROM metodologia.persona p, metodologia.temporal t WHERE p.`idPERSONA`=t.`idPERSONA`";
