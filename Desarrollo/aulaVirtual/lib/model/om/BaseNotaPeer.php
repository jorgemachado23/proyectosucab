...
abstract class BaseNotaPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Idnota', 'CreatedAt', 'UpdatedAt', 'Nota', 'Idpersona', 'Idevaluacion', 'Idlapso', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('idnota', 'createdAt', 'updatedAt', 'nota', 'idpersona', 'idevaluacion', 'idlapso', ),
		BasePeer::TYPE_COLNAME => array (self::IDNOTA, self::CREATED_AT, self::UPDATED_AT, self::NOTA, self::IDPERSONA, self::IDEVALUACION, self::IDLAPSO, ),
		BasePeer::TYPE_FIELDNAME => array ('idnota', 'created_at', 'updated_at', 'nota', 'idpersona', 'idevaluacion', 'idlapso', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Idnota' => 0, 'CreatedAt' => 1, 'UpdatedAt' => 2, 'Nota' => 3, 'Idpersona' => 4, 'Idevaluacion' => 5, 'Idlapso' => 6, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('idnota' => 0, 'createdAt' => 1, 'updatedAt' => 2, 'nota' => 3, 'idpersona' => 4, 'idevaluacion' => 5, 'idlapso' => 6, ),
		BasePeer::TYPE_COLNAME => array (self::IDNOTA => 0, self::CREATED_AT => 1, self::UPDATED_AT => 2, self::NOTA => 3, self::IDPERSONA => 4, self::IDEVALUACION => 5, self::IDLAPSO => 6, ),
		BasePeer::TYPE_FIELDNAME => array ('idnota' => 0, 'created_at' => 1, 'updated_at' => 2, 'nota' => 3, 'idpersona' => 4, 'idevaluacion' => 5, 'idlapso' => 6, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(NotaPeer::IDLAPSO);
