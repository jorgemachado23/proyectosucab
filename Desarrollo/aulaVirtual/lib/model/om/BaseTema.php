...
abstract class BaseTema extends BaseObject  implements Persistent {
  ...
  const PEER = 'TemaPeer';
	...
	/**
	 * Initializes internal state of BaseTema object.
	 * @see        applyDefaults()
	 */
	...
	public function setIdtema($v)
	{
		...
		if ($this->idtema !== $v) {
			$this->idtema = $v;
			$this->modifiedColumns[] = TemaPeer::IDTEMA;
		}
	...
	public function setUpdatedAt($v)
	{
		...
		if ( $this->updated_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = TemaPeer::UPDATED_AT;
			}
		} // if either are not null
	...
	public function setDescripcion($v)
	{
		...
		if ($this->descripcion !== $v) {
			$this->descripcion = $v;
			$this->modifiedColumns[] = TemaPeer::DESCRIPCION;
		}
	...
	public function setIdpersona($v)
	{
		...
		if ($this->idpersona !== $v) {
			$this->idpersona = $v;
			$this->modifiedColumns[] = TemaPeer::IDPERSONA;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->idtema = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
			$this->nombre = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
			$this->created_at = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
			$this->updated_at = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
			$this->descripcion = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
			$this->idpersona = ($row[$startcol + 5] !== null) ? (int) $row[$startcol + 5] : null;
			$this->resetModified();
			...
			return $startcol + 6; // 6 = TemaPeer::NUM_COLUMNS - TemaPeer::NUM_LAZY_LOAD_COLUMNS).
    ...
    if ($this->isModified() && !$this->isColumnModified(TemaPeer::UPDATED_AT))
    {
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					$this->setIdtema($pk);  //[IMV] update autoincrement primary key
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[5], $arr)) $this->setIdpersona($arr[$keys[5]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(TemaPeer::IDTEMA)) $criteria->add(TemaPeer::IDTEMA, $this->idtema);
		...
		if ($this->isColumnModified(TemaPeer::UPDATED_AT)) $criteria->add(TemaPeer::UPDATED_AT, $this->updated_at);
		if ($this->isColumnModified(TemaPeer::DESCRIPCION)) $criteria->add(TemaPeer::DESCRIPCION, $this->descripcion);
		if ($this->isColumnModified(TemaPeer::IDPERSONA)) $criteria->add(TemaPeer::IDPERSONA, $this->idpersona);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(TemaPeer::IDTEMA, $this->idtema);
	...
	/**
	 * Generic method to set the primary key (idtema column).
	 *
  ...
  {
    if (!$callable = sfMixer::getCallable('BaseTema:'.$method))
    {
      throw new sfException(sprintf('Call to undefined method BaseTema::%s', $method));
    }
