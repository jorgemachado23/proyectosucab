...
abstract class BasePersona extends BaseObject  implements Persistent {
  ...
  const PEER = 'PersonaPeer';
	...
	/**
	 * The value for the segundonombre field.
	 * @var        string
	 */
	...
	/**
	 * The value for the segundoapellido field.
	 * @var        string
	 */
	...
	/**
	 * Get the [segundonombre] column value.
	 * 
	 * @return     string
	 */
	...
	/**
	 * Get the [segundoapellido] column value.
	 * 
	 * @return     string
	 */
	...
	public function setIdpersona($v)
	{
		...
		if ($this->idpersona !== $v) {
			$this->idpersona = $v;
			$this->modifiedColumns[] = PersonaPeer::IDPERSONA;
		}
	...
	/**
	 * Set the value of [segundonombre] column.
	 * 
	 * @param      string $v new value
	 * @return     Persona The current object (for fluent API support)
	 */
	public function setSegundonombre($v)
	{
		...
		if ($this->segundonombre !== $v) {
			$this->segundonombre = $v;
			$this->modifiedColumns[] = PersonaPeer::SEGUNDONOMBRE;
		}
	...
	/**
	 * Set the value of [segundoapellido] column.
	 * 
	 * @param      string $v new value
	 * @return     Persona The current object (for fluent API support)
	 */
	public function setSegundoapellido($v)
	{
		...
		if ($this->segundoapellido !== $v) {
			$this->segundoapellido = $v;
			$this->modifiedColumns[] = PersonaPeer::SEGUNDOAPELLIDO;
		}
	...
	public function setTipo($v)
	{
		...
		if ($this->tipo !== $v) {
			$this->tipo = $v;
			$this->modifiedColumns[] = PersonaPeer::TIPO;
		}
	...
	public function setCuenta($v)
	{
		...
		if ($this->cuenta !== $v) {
			$this->cuenta = $v;
			$this->modifiedColumns[] = PersonaPeer::CUENTA;
		}
	...
	public function setSeccion($v)
	{
		...
		if ($this->seccion !== $v) {
			$this->seccion = $v;
			$this->modifiedColumns[] = PersonaPeer::SECCION;
		}
	...
	public function hasOnlyDefaultValues()
	{
			...
			if (array_diff($this->modifiedColumns, array(PersonaPeer::ESTADO))) {
				return false;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->idpersona = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
			$this->nombre = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
			$this->segundonombre = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
			$this->apellido = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
			$this->segundoapellido = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
			$this->tipo = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
			$this->cuenta = ($row[$startcol + 6] !== null) ? (string) $row[$startcol + 6] : null;
			$this->clave = ($row[$startcol + 7] !== null) ? (string) $row[$startcol + 7] : null;
			$this->seccion = ($row[$startcol + 8] !== null) ? (string) $row[$startcol + 8] : null;
			$this->estado = ($row[$startcol + 9] !== null) ? (string) $row[$startcol + 9] : null;
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[2] => $this->getSegundonombre(),
			$keys[3] => $this->getApellido(),
			$keys[4] => $this->getSegundoapellido(),
			$keys[5] => $this->getTipo(),
			$keys[6] => $this->getCuenta(),
			$keys[7] => $this->getClave(),
			$keys[8] => $this->getSeccion(),
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[2], $arr)) $this->setSegundonombre($arr[$keys[2]]);
		if (array_key_exists($keys[3], $arr)) $this->setApellido($arr[$keys[3]]);
		if (array_key_exists($keys[4], $arr)) $this->setSegundoapellido($arr[$keys[4]]);
		if (array_key_exists($keys[5], $arr)) $this->setTipo($arr[$keys[5]]);
		if (array_key_exists($keys[6], $arr)) $this->setCuenta($arr[$keys[6]]);
		if (array_key_exists($keys[7], $arr)) $this->setClave($arr[$keys[7]]);
		if (array_key_exists($keys[8], $arr)) $this->setSeccion($arr[$keys[8]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(PersonaPeer::IDPERSONA)) $criteria->add(PersonaPeer::IDPERSONA, $this->idpersona);
		if ($this->isColumnModified(PersonaPeer::NOMBRE)) $criteria->add(PersonaPeer::NOMBRE, $this->nombre);
		if ($this->isColumnModified(PersonaPeer::SEGUNDONOMBRE)) $criteria->add(PersonaPeer::SEGUNDONOMBRE, $this->segundonombre);
		if ($this->isColumnModified(PersonaPeer::APELLIDO)) $criteria->add(PersonaPeer::APELLIDO, $this->apellido);
		if ($this->isColumnModified(PersonaPeer::SEGUNDOAPELLIDO)) $criteria->add(PersonaPeer::SEGUNDOAPELLIDO, $this->segundoapellido);
		if ($this->isColumnModified(PersonaPeer::TIPO)) $criteria->add(PersonaPeer::TIPO, $this->tipo);
		if ($this->isColumnModified(PersonaPeer::CUENTA)) $criteria->add(PersonaPeer::CUENTA, $this->cuenta);
		if ($this->isColumnModified(PersonaPeer::CLAVE)) $criteria->add(PersonaPeer::CLAVE, $this->clave);
		if ($this->isColumnModified(PersonaPeer::SECCION)) $criteria->add(PersonaPeer::SECCION, $this->seccion);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(PersonaPeer::IDPERSONA, $this->idpersona);
	...
	/**
	 * Generic method to set the primary key (idpersona column).
	 *
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setSegundonombre($this->segundonombre);

		$copyObj->setApellido($this->apellido);

		$copyObj->setSegundoapellido($this->segundoapellido);
		...
		$copyObj->setSeccion($this->seccion);
