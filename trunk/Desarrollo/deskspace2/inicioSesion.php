        ...
        <form id="form1" name="form1" method="post" action="">
          <table width="705" border="0">
            <tr>
              ...
              <td><input name="nombreUsuario" type="text" id="nombreUsuario" size="60"/></td>
            </tr>
            <tr>
              <td>Contraseña</td>
              <td><input type="password" name="clave" id="clave" size="60"/></td>
            </tr>
          </table>
          <div align="center">
            <p>
              <input type="submit" name="inicioSesion" id="inicioSesion" value="Iniciar Sesión" />
            </p>
