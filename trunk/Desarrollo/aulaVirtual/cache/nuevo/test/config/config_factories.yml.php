...
$logger = new sfFileLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array (
  'level' => 'debug',
  'file' => 'C:\\wamp\\www\\aulaVirtual\\log/nuevo_test.log',
)));
$this->factories['logger']->addLogger($logger);
  ...
  'cache_dir' => 'C:\\wamp\\www\\aulaVirtual\\cache\\nuevo\\test\\i18n',
  'lifetime' => 31556926,
  'prefix' => 'C:\\wamp\\www\\aulaVirtual\\apps\\nuevo/i18n',
));
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('symfony'),
  ...
  'session_path' => 'C:\\wamp\\www\\aulaVirtual\\cache\\nuevo\\test\\test/sessions',
))));
