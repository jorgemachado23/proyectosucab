  ...
  const PEER = 'DocumentoPeer';
	...
	public function setCreatedAt($v)
	{
		...
		if ( $this->created_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = DocumentoPeer::CREATED_AT;
			}
	...
	public function setUpdatedAt($v)
	{
		...
		if ( $this->updated_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = DocumentoPeer::UPDATED_AT;
			}
		} // if either are not null
	...
	public function setIddocumento($v)
	{
		...
		if ($this->iddocumento !== $v) {
			$this->iddocumento = $v;
			$this->modifiedColumns[] = DocumentoPeer::IDDOCUMENTO;
		}
	...
	public function setIdpersona($v)
	{
		...
		if ($this->idpersona !== $v) {
			$this->idpersona = $v;
			$this->modifiedColumns[] = DocumentoPeer::IDPERSONA;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->iddocumento = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
			...
			return $startcol + 5; // 5 = DocumentoPeer::NUM_COLUMNS - DocumentoPeer::NUM_LAZY_LOAD_COLUMNS).
    ...
    if ($this->isNew() && !$this->isColumnModified(DocumentoPeer::CREATED_AT))
    {
      $this->setCreatedAt(time());
    }

    if ($this->isModified() && !$this->isColumnModified(DocumentoPeer::UPDATED_AT))
    {
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[2], $arr)) $this->setIddocumento($arr[$keys[2]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(DocumentoPeer::CREATED_AT)) $criteria->add(DocumentoPeer::CREATED_AT, $this->created_at);
		if ($this->isColumnModified(DocumentoPeer::UPDATED_AT)) $criteria->add(DocumentoPeer::UPDATED_AT, $this->updated_at);
		if ($this->isColumnModified(DocumentoPeer::IDDOCUMENTO)) $criteria->add(DocumentoPeer::IDDOCUMENTO, $this->iddocumento);
		if ($this->isColumnModified(DocumentoPeer::NOMBRE)) $criteria->add(DocumentoPeer::NOMBRE, $this->nombre);
		if ($this->isColumnModified(DocumentoPeer::IDPERSONA)) $criteria->add(DocumentoPeer::IDPERSONA, $this->idpersona);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(DocumentoPeer::CREATED_AT, $this->created_at);
	...
	/**
	 * Generic method to set the primary key (created_at column).
	 *
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setIddocumento($this->iddocumento);
