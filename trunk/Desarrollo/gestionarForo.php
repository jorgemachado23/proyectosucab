  ...
  <div id="container">
	...
	mysql_select_db("metodologia", $conexion); 
				...
				if ($totEmp> 0) {
			 	...
			 	echo "<tr style='background:url(images/content_extender.jpg)'><p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong><a href='mostrarComentarios.php?tema=".$rowEmp['nombre']."' style='color:#666666; font-style:italic; font-size:14px;font-family:Verdana, Arial, Helvetica, sans-serif' >".$rowEmp ['nombre']."</a></strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='borrarTema.php?tema=".$rowEmp['idtema']."'class='home' id='link_home' style='color:#333333; font-size:12px;text-decoration: none;font-family:Verdana, Arial, Helvetica, sans-serif'>Borrar</a>&nbsp;&nbsp;<a href='modificarTema.php?tema=".$rowEmp['idtema']."' class='home' id='link_home' style='color:#333333; font-size:12px;text-decoration: none;font-family:Verdana, Arial, Helvetica, sans-serif'>Modificar</a></p></tr>";
						
				echo "<tr style='background:url(images/content_extender.jpg)'><p style='font-size:20; font-style:italic;font-family:Verdana, Arial, Helvetica, sans-serif' >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;".$rowEmp ['fecha']."</p></tr>";
				echo "<tr style='background:url(images/content_extender.jpg)'><p style='font-size:20; font-style:italic;font-family:Verdana, Arial, Helvetica, sans-serif' class='entry-content' >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Descripción: ".$rowEmp ['descripcion']."</p>"; "</tr>&nbsp;&nbsp;&nbsp;&nbsp;";
