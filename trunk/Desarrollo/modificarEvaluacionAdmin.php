        ...
        <form id="form1" name="form1" method="post" action="" style="font-family:Verdana, Arial, Helvetica, sans-serif">
          <div align="center">Evaluacion: 
            <select name='select' id='select'>
              <?php 
			$conexion = mysql_connect("127.0.0.1", "dory", "dvazquez");
	...
	mysql_select_db("metodologia", $conexion); 
		 ...
		 <br /><br />
          ...
          <table width='477' border='0' align='enter'>
            <tr>
              ...
              <td width='189'><input name='nombreEval' type='text' id='nombreEval' value='$nombre' size='45' style='font-family:Verdana, Arial, Helvetica, sans-serif'/></td>
            </tr>
            <tr>
              <td>Porcentaje:</td>
              <td ><input name='porcentajeEval' type='text' id='porcentajeEval' value=".$rowEmp['porcentaje']." size='10' style='font-family:Verdana, Arial, Helvetica, sans-serif' />
                %</td>
            </tr>
            <tr>
              <td>Tipo: </td>
		...
		if ($tipo == "VIRTUAL")
		{
            ...
            <tr>
              ...
              <td><textarea name='descripcionEval' cols='50' rows='4' id='descripcionEval' style='font-family:Verdana, Arial, Helvetica, sans-serif'>$descripcion</textarea></td>
