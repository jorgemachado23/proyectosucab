    ...
    <div id="contentPagPpalforo">
      <div id="content_top">
        <div class="post">
		 ...
		 <p>&nbsp;</p>
		 <h2 align="center">Eliminar Alumnos</h2>
         <p>&nbsp;</p  
		 ><td align="left"><div align="center">¿Esta seguro que desea eliminar todos los alumnos agregados anteriormente?</div></td>
...
if (isset($_POST["aceptar"]))
{
	...
	<script language="javascript">
		window.alert ( "Los alumnos se han eliminado exitosamente." );
