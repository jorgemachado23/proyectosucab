...
<table id="Table_01" width="1024" height="1241" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td>
    <!--Cerrar Sesion-->
     <!-- InstanceBeginEditable name="Cerrar Sesion" -->	  <h2><a href="cerrarSesion.php" class="home" id="link_home" style="color:#666666; font-style:italic; font-size:18px;">Cerrar Sesión >></a></h2><!-- InstanceEndEditable -->
    </td>
  </tr>
</table>
...
<h2 align="center">Inhabilitar Alumno</h2>
		 <p>&nbsp;</p>
		 <div align="center">Seleccione la sección a la cual pertenece el alumno que desea inhabilitar</div>
		  <p>&nbsp;</p>
...
mysql_select_db("cole9858_aulavirtual", $conexion);  
		...
		if ($totEmp> 0) {
		 ...
		 <br /><br />
		  ...
		  <tr>
		  Seleccione el alumno que desea Inhabilitar
		  <br></br>
...
mysql_select_db("cole9858_aulavirtual", $conexion); 
	...
	$queEval = "update PERSONA set estado = 'Inactivo' where idPERSONA = $alumno";
	$resEval = mysql_query($queEval, $conexion) or die(mysql_error());
	
	?>
          <script language="javascript">
		  window.alert ( "El alumno fue inhabilitado con éxito");
