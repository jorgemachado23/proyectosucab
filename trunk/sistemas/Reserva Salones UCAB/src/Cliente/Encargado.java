...
import ReservaSalonesUCAB.GUILog;
...
class Encargado extends Cliente
{
    ...
    public static void main(String[] args)
    {
		try
        {
            controlEncargado = new Encargado();
    ...
    public void AsignarSalon(String Salon, String Usuario, String dia, String FechaIni, String FechaFin)
    {
